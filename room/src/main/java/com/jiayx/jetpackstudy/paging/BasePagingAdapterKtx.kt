package com.jiayx.jetpackstudy.paging
...
abstract class BasePagingAdapterKtx<T : Any> : PagingDataAdapter<T, RecyclerView.ViewHolder> {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        (holder as? BasePagingAdapterKtx<*>.ViewHolder)?.onBindViewHolder(position)
    }
   ...
   /* fun prependItem(item: T) {
    ...
    override fun onBindViewHolder(
        ...
        if (payloads.isEmpty()) {
            ...
            val viewHolder = holder as? BasePagingAdapterKtx<*>.ViewHolder
            ...
            if (itemHolder != null) {
                ...
                (holder as? BasePagingAdapterKtx<*>.ViewHolder)?.onBindViewHolder(
                    position,
                    payloads
                )
            }
    ...
    inner class ViewHolder internal constructor(parent: ViewGroup, layout: Int) :
        ...
        init {
            ...
            itemHelper.setRVAdapter(this@BasePagingAdapterKtx)
        ...
        override fun onClick(v: View) {
            if (::mOnItemClickListener.isInitialized) {
                mOnItemClickListener(this@BasePagingAdapterKtx, v, mPosition)
            }
        }

        override fun onLongClick(v: View): Boolean {
            if (::mOnItemLongClickListener.isInitialized) {
                mOnItemLongClickListener(this@BasePagingAdapterKtx, v, mPosition)
                return true
            }
            return false
        }
    ...
    class ItemHelper(private val viewHolder: BasePagingAdapterKtx<*>.ViewHolder) :
        ...
        lateinit var adapter: BasePagingAdapterKtx<out Any>
            private set
        ...
        private lateinit var mOnItemChildClickListener:
                    (adapter: BasePagingAdapterKtx<out Any>, v: View, position: Int) -> Unit
        ...
        fun setRVAdapter(PagedListAdapter: BasePagingAdapterKtx<out Any>) {
        ...
        private fun <V : View> getViewById(@IdRes viewId: Int, call: (V) -> Unit = {}): ItemHelper {
            val view = findViewById<V>(viewId)
            call(view)
            return this
        }

        private fun <V : View> getViewById(@IdRes viewId: Int): View {
         ...
         * @param viewId 控件id
         */
        fun setCheckBox(@IdRes viewId: Int, flag: Boolean): ItemHelper {
            getViewById<View>(viewId) {
                if (it is CheckBox) {
                    it.isChecked = flag
                } else {
                    val entryName = it.resources.getResourceEntryName(viewId)
                    throw ClassCastException("id: R.id.$entryName are not CheckBox")
                }
            }
            return this
        }
        fun setCheckedTextView(@IdRes viewId: Int, flag: Boolean): ItemHelper {
            getViewById<View>(viewId) {

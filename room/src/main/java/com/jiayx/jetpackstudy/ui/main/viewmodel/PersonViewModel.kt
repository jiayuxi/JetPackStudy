...
class PersonViewModel(application: Application) : AndroidViewModel(application) {
    ...
    open var manageListener: (() -> Unit)? = null
    open var deleteListener: (() -> Unit)? = null
     ...
     * 更新数据
     */
    fun updateAll(flag: Boolean) = viewModelScope.launch(Dispatchers.IO) {
        repository.updateAll(flag)
    }

    /**
     * 删除数据
     */
    fun deleteSelect() = viewModelScope.launch(Dispatchers.IO) {
